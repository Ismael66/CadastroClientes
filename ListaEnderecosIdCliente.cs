...
{
    public partial class ListaEnderecosIdCliente : Form
    {
        public ListaEnderecosIdCliente()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (Guid.TryParse(tb_id.Text, out var NewGuid))
            {
                ...
                var infos = endereco.ObterDados(parametros, idDigitado, "id_cliente");
                if (infos.Count > 0)
                {
        ...
        private void ListaEnderecosIdCliente_FormClosed(object sender, FormClosedEventArgs e)
        {
